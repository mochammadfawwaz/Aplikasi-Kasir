 ...
 * @author Mojave
 */
public class StokKeluar extends javax.swing.JInternalFrame {
    ...
    private void getTable(){
        ...
        resultSet = connection.querySellect(column, nameTable);
        ...
        try{
            ...
            connection.closeDatabase();
            tblStokKeluar.setModel(model);
        }catch(SQLException e){
            System.out.println("Error try to populate tabel stok masuk :" 
                    + e.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        tblStokKeluar = new javax.swing.JTable();
        ...
        tblStokKeluar.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblStokKeluar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblStokKeluarMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblStokKeluar);
    ...
    private void tblStokKeluarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblStokKeluarMouseClicked
        
        int baris = tblStokKeluar.getSelectedRow();
        int kolomTanggal = 2;
        int kolomBarcode = 3;
        int kolomJumlah = 4;
        ...
        String dateValue = 
                String.valueOf(tblStokKeluar.getValueAt(baris, kolomTanggal));
        String barcode = 
        ...
        try{
            ...
            System.out.println("Error try to parse date format: " 
                    + e.getMessage()); 
        }
    ...
    }//GEN-LAST:event_tblStokKeluarMouseClicked
    ...
    private void btnEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditMouseClicked
        ...
        if(tanggal.isEmpty() || "pilih".equals(barcode) 
            ...
            String id = String.valueOf(tblStokKeluar.getValueAt(baris, kolom));
            String nameTable = "stok_keluar";
            String[] column = {"tanggal_masuk", "barcode", "jumlah", "keterangan"};
            String[] value = {tanggal, barcode, jumlah, keterangan};
    ...
    private javax.swing.JTable tblStokKeluar;

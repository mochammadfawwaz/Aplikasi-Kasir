...
public class Transaksi extends javax.swing.JInternalFrame {
    ...
    private void tblMenuTransaksiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMenuTransaksiMouseClicked
        ...
        int nilaiHarga = Integer.parseInt(hargaBarang);
        int nilaiJumlahBarang = Integer.parseInt(jumlahBarang);
        int nilaiSubtotal = nilaiHarga * nilaiJumlahBarang;
        
        String subtotal = String.valueOf(nilaiSubtotal);
